...
### <Definition>
* **English (Source 1 - IBM):** "Full-stack development refers to the end-to-end development of an application, including both the front-end (client-side) and back-end (server-side) portions."
...
### <References>
* [IBM - What is Full-Stack Development?](https://www.ibm.com/think/topics/full-stack-development)
